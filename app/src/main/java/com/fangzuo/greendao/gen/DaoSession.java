...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        noticBeanDaoConfig = daoConfigMap.get(NoticBeanDao.class).clone();
        noticBeanDaoConfig.initIdentityScope(type);
        ...
        noticBeanDao = new NoticBeanDao(noticBeanDaoConfig, this);
    ...
    public void clear() {
        ...
        noticBeanDaoConfig.clearIdentityScope();
    }
