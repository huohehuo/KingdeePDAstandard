...
//        LoadBasicData();
    ...
    private void LoadBasicData() {
        ...
        spCapture.setAutoSelection(getString(R.string.spCapture_pd_hbrk), "");
        spYanshou.setAutoSelection(getString(R.string.spYanshou_pd_hbrk), "");
        spManager.setAutoSelection(getString(R.string.spManager_pd_hbrk), "");
    ...
    protected void initListener() {
        ...
        ivScan.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(HBDPDCPRKActivity.this);
...
//            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
//                Employee capture = (Employee) employeeAdapter.getItem(i);
//                ManagerId = capture.FItemID;
//                ManagerName = capture.FName;
//                if (isFirst2){
//                    share.setPDPOPurchaseScop(i);
//                    spManager.setSelection(i);
//                }
//                else{
//                    spManager.setSelection(share.getPDPOPurchaseScop());
//                    isFirst2=true;
//                }
//            }
//
...
//                if (isFirst3){
//                    share.setHBDPDCPRKCapture(i);
//                    spCapture.setSelection(i);
//                }
//                else{
//                    spCapture.setSelection(share.getHBDPDCPRKCapture());
//                    isFirst3=true;
//                }
//            }
//
    ...
    private void Addorder() {
        try {
            if (product != null) {
                ...
                t_main.FRemark = "";
                t_main.FCustody = spManager.getEmployeeId();
