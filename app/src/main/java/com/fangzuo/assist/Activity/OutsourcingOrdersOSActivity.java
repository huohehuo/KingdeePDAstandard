...
//    private String signPersonName;
    ...
    private void LoadBasicData() {
        ...
        spCapturePerson.setAutoSelection(getString(R.string.spCapturePerson_pd_ooos), "");
        spSignPerson.setAutoSelection(getString(R.string.spSignPerson_pd_ooos), "");
    ...
    protected void initListener() {
        ...
        ivScan.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(OutsourcingOrdersOSActivity.this);
...
//                if (i > 0 && mains.get(i).FDeliveryType.equals(mains.get(i - 1).FDeliveryType)) {
        ...
        pBean.list = data;
        DataModel.upload( WebApi.PushDownOCOSUpload, gson.toJson(pBean));
//        postToServer(data);
