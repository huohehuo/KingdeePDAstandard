...
//                        break;
    ...
    protected void initView() {
        setContentView(R.layout.activity_push_down_sn);
        mContext = this;
    ...
    protected void initListener() {
        ...
        ivScan.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(PushDownSNActivity.this);
...
//                if (isFirst){
//                    share.setPDSNSendman(i);
//                    spSendman.setSelection(i);
//                }
//                else{
//                    spSendman.setSelection(share.getPDSNSendman());
//                    isFirst=true;
//                }
//            }
//
...
//                if (isFirst2){
//                    share.setPDSNCapture(i);
//                    spCapture.setSelection(i);
//                }
//                else{
//                    spCapture.setSelection(share.getPDSNCapture());
//                    isFirst2=true;
//                }
//            }
//
