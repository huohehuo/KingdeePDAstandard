    ...
    private void upload() {
        ...
        for (int i = 0; i < mains.size(); i++) {
            if (i > 0 && mains.get(i).orderId == mains.get(i - 1).orderId) {
                ...
                main = t_main.FMakerId + "|" + t_main.orderDate + "|" + t_main.FDepartmentId + "|" + t_main.FSalesManId + "|" + t_main.FDirectorId + "|" +
                        t_main.supplierId + "|" + t_main.Rem + "|" + t_main.FSendOutId + "|" + t_main.FCustodyId + "|" +
                        t_main.FRedBlue + "|" + t_main.FAcountID + "|" + t_main.sourceOrderTypeId + "|";
                puBean.main = main;
                ...
                for (int j = 0; j < details.size(); j++) {
                    if (j != 0 && j % 49 == 0) {
                        ...
                        detail = detail + t_detail.FProductId + "|" + t_detail.FUnitId + "|" + t_detail.FTaxUnitPrice + "|" +
                                t_detail.FQuantity + "|" + t_detail.FDiscount + "|" + t_detail.FStorageId + "|" + t_detail.FBatch + "|" +
        ...
        pBean.list = data;
        DataModel.upload(mContext,getBaseUrl()+ WebApi.OTHERINSTORE,gson.toJson(pBean));
//        postToServer(data);
    }
