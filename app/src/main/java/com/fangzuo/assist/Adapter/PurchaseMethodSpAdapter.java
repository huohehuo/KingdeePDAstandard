...
public class PurchaseMethodSpAdapter extends BaseAdapter {
    Context context;
    List<PurchaseMethod> items;
    private ViewHolder viewHolder;

    public PurchaseMethodSpAdapter(Context context, List<PurchaseMethod> items) {
    ...
    public PurchaseMethod getChild(int i){
        return items.get(i);
    }
