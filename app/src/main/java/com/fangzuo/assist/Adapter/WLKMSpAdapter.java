...
public class WLKMSpAdapter extends BaseAdapter {
    Context context;
    List<Wanglaikemu> items;
    private ViewHolder viewHolder;

    public WLKMSpAdapter(Context context, List<Wanglaikemu> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv.setText(items.get(i).FFullName);
        return view;
    }
