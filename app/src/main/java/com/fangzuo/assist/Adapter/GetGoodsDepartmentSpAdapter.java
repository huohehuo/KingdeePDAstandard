...
public class GetGoodsDepartmentSpAdapter extends BaseAdapter {
    Context context;
    List<GetGoodsDepartment> items;
    private ViewHolder viewHolder;

    public GetGoodsDepartmentSpAdapter(Context context, List<GetGoodsDepartment> items) {
    ...
    public long getItemId(int i) {
        return Long.parseLong(items.get(i).FItemID);
    }
