...
public class SpinnerPeopleUI extends RelativeLayout {
    // 返回按钮控件
    private Spinner mSp;
    // 标题Tv
    ...
    public SpinnerPeopleUI(Context context, AttributeSet attributeSet) {
        ...
        mText = (AppCompatTextView) findViewById(R.id.tv_title);
...
//                    mText.setTextSize(attrArray.getDimension(R.styleable.ManSpinner_manspinner_size, 18));
        ...
        attrArray.recycle();
        mSp.setPrompt("请选择"+mTitleTv.getText().toString());
