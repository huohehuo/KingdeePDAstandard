...
public class SpinnerPurchaseMethod extends RelativeLayout {
    // 返回按钮控件
    private Spinner mSp;
    // 标题Tv
    ...
    private String Id="";
    private String Name="";
    private String T="采购方式：";     //15


    public SpinnerPurchaseMethod(Context context, AttributeSet attributeSet) {
